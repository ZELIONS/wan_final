...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-4" href="index.html" style="font-size: 35px">BooksVerse</a>
        <!-- Sidebar Toggle-->
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <?php
                            ...
                            ?>
                        <a class="nav-link" href="?page=tambah-petugas">
                        ...
                        <?php
                            ...
                            ?>
                        <a class="nav-link" href="?page=total_user">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; BooksVerse 2023</div>
                        <div>
