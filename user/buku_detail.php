    ...
    <section id="" style="margin-top: 50px; margin-left:40px">
        <div class=" d-flex gap-5">
            <div class="card border-0">
                <img src="../assets/img/<?php echo $buku['gambar']; ?>" class="img-fluid" style="width: auto; height: auto%;" alt="">
                <br>
                <button onclick="window.location.href = 'peminjaman_tambah.php?id=<?php echo $buku['id_buku']; ?>';" style="border: 1px solid black; border-radius: 5px; padding: 5px 10px; color: black; margin-bottom: 10px;">Pinjam</button>
                <button style="border: 1px solid black; border-radius: 5px; padding: 5px 10px; color: black;">
                    <a href="proses_koleksi.php?id=<?php echo $buku['id_buku']; ?>" style="text-decoration: none; color: inherit;">+ Tambah Koleksi</a>
                </button>
            </div>
