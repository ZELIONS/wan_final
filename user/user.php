...
<body>
    ...
    <div class="hero-title">
        <h1 class="font">Perpustakaan Online Anda</h1>
        <h6 class="font2">Temukan jurnal akademis, artikel, & buku dalam satu platform yang mulus</p>
    </div>
    <section id="hero">
            ...
            <footer>
                <div class="row">
                    ...
                    <div class="col-12 col-md-3 mb-3">
                        ...
                        <p>Jl. Cemapa, No 111, Medan, Sumatera Utara.</p>
                    </div>
                </div>
            </footer>
        </div>
